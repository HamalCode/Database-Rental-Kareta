...
<body>
	...
	<table>
		<thead>
		<tr><th>No.</th> <th>ID</th><th>NARAN KARETA</th> 
	...
	<?php 
		...
		$Qf=$mietib->query("SELECT * FROM t_kareta");
		if($Qf->rowCount()>0){
			$no=0;	
			while ($Df=$Qf->fetch(PDO::FETCH_LAZY)) {
				...
				echo "<td>$Df[nrn_kareta] </td>";
				echo "<td align='center'>$Df->inc_kareta </td>";
				echo "<td>$Df->obs_kareta </td>";
